    ...
    return (
      (t.prototype.init = function () {
        ...
        (this._address.innerHTML =
          "Nishan Dhungana<br class='sp-br'><br>2023 © Nishan Dhungana. Design by Nd Developers<br><a href='#' target='_blank'>[ Google MAP ]</a>"),
        ...
        (this._modalTxt.innerHTML =
          "<div class='c-comm'>下記のメールアドレスよりお問い合わせください</div><div class='c-info en'><a href='mailto:info@nishandhungana.com'>info@nishandhungana.com</a></div><span>Nishan Dhuungana<br class='sp-br'> <br>2022 © Nishan Dhungana. Design by Nd Developers<br>"),
    ...
    return (
      (t.prototype.setData = function (t) {
        for (var e = (this._firstLoadCheck = 0); e < t.length; e++) {
          ...
          (i.id = e),
            (i.title_ja =
              t[e].getElementsByClassName("dt-w-title-ja")[0].innerHTML),
            (i.title_en =
